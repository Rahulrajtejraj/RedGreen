...
# ===================== USER CONFIG =====================
API_KEY      = "Oa0Wf8VR"
CLIENT_CODE  = "AACB598526"
PASSWORD     = "7827"
TOTP_SECRET  = "KHMKKLVGWBFQGOO3HTWW5DRKME"

# Telegram
TELEGRAM_BOT_TOKEN = "8276818865:AAG2s3HSAH1S9fvHrnuo4VyyzRPHzrLYQ2Q"
ALLOWED_CHAT_ID = 5138308001

# Files
TRADE_LOG_FILE = "RKALE/Redgreen_log.csv"
TRADE_LOG_XLSX = "RKALE/RedGreen_log_withchart.xlsx"
STATE_PERSIST_FILE = "RKALE/RKALE_bot_state.json"
...
# Chart / excel helpers
def _build_daily_pnl_chart(csv_path: str, out_png: str = "RKALE/Rkale_daily_pnls.png") -> bool:
    try:
...
def _write_csv_to_excel_and_embed_chart(csv_path: str, xlsx_path: str, chart_png: str = "RKALE/Rkale_daily_pnls.png"):
    try:
        df = _pd.read_csv(csv_path)
    except Exception:
        return
...
def update_excel_with_daily_pnl():
    png = "RKALE/Rkale_daily_pnls.png"
